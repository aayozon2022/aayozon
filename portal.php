...
<html lang="en-US">
<head>
<title>Aayozon - Send Details Over Email with Attachment on Form Submission</title>
<meta charset="utf-8">

<!-- Stylesheet file -->
<link rel="stylesheet" href="fastnfurious/style.css"/>
</head>
<body>
<div class="container">
    <h1>Fast Forward With Aayozon</h1>
    <div class="form-wrapper">
        <form method="post" action="" enctype="multipart/form-data" class="animate-form">
            <h4 class="headt">Register Your Details Portal</h4>
